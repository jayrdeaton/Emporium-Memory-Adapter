...
describe('MemoryAdapter', () => {
  ...
  describe('Storable.create({})', () => {
    it('should create a new storable with set values', async () => {
      const object = {id: faker.random.uuid(), key: faker.random.word()};
  ...
  describe('Storable.create([])', () => {
    it('should create two new storables with set values', async () => {
      const a = {id: faker.random.uuid(), key: faker.random.word()};
      const b = {id: faker.random.uuid(), key: faker.random.word()};
